...
def cliff_formula(g: int) -> str:
    ...
    """
    diff = g - 5
    s = _valuation(diff) if diff != 0 else 999
...
def prove_cliff_constant(verbose: bool = False) -> bool:
    ...
    checks = [
        ...
        ("v_2(L_unit+1) = 5", _valuation(two_adic_log5(10) // 4 + 1) == 5),
    ]
