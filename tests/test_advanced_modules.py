...
class TestSeparation(unittest.TestCase):
    def test_newton_trajectory(self):
        from dual_view.separation import newton_trajectory
        k = 8
        a = pow(5, 3, 1 << k)
    ...
    def test_predicted_separation(self):
        from dual_view.separation import predicted_separation
    ...
    def test_step_count_profile(self):
        from dual_view.separation import step_count_profile
...
class TestFourier(unittest.TestCase):
    def test_step_count_fn_shape(self):
        from dual_view.fourier import step_count_fn
        k = 6
        h = step_count_fn(k, 3)
        self.assertEqual(len(h), 1 << (k - 2))

    def test_analytic_step_count(self):
        from dual_view.fourier import analytic_step_count
        k = 6
        h = analytic_step_count(k, 3)
        self.assertEqual(len(h), 1 << (k - 2))

    def test_analytic_matches_numeric(self):
        from dual_view.fourier import step_count_fn, analytic_step_count
        k = 6
    ...
    def test_power_spectrum(self):
        from dual_view.fourier import power_spectrum
    ...
    def test_fourier_summary(self):
        from dual_view.fourier import fourier_summary
...
class TestPadicRoots(unittest.TestCase):
    def test_newton_step(self):
        from dual_view.padic_roots import newton_step
        pk = 5 ** 4
        x = newton_step(2, 8, pk)
        self.assertIsInstance(x, int)

    def test_halley_step(self):
        from dual_view.padic_roots import halley_step
        pk = 5 ** 4
        x = halley_step(2, 8, pk)
        self.assertIsInstance(x, int)

    def test_convergence_profile(self):
        from dual_view.padic_roots import convergence_profile, newton_step, lift_root
        p, k = 5, 4
        a = 8
    ...
    def test_popcount_compression(self):
        from dual_view.padic_roots import popcount_compression
...
class TestIwasawa(unittest.TestCase):
    def test_congruence_depth(self):
        from dual_view.iwasawa import congruence_depth
        M = [[1, 0], [0, 1]]
    ...
    def test_filtration_residue(self):
        from dual_view.iwasawa import filtration_residue, congruence_depth
        M = [[3, 0], [0, 3]]
    ...
    def test_ldu_decompose(self):
        from dual_view.iwasawa import ldu_decompose
        M = [[5, 3], [2, 7]]
    ...
    def test_matrix_coordinates(self):
        from dual_view.iwasawa import matrix_coordinates
        M = [[5, 3], [2, 7]]
    ...
    def test_matrix_commutator(self):
        from dual_view.iwasawa import matrix_commutator
        M = [[5, 0], [0, 5]]
        N = [[7, 0], [0, 7]]
    ...
    def test_filtration_portrait(self):
        from dual_view.iwasawa import filtration_portrait
...
class TestMersenne(unittest.TestCase):
    def test_mersenne_coordinates(self):
        from dual_view.mersenne import mersenne_coordinates
    ...
    def test_verify_core_identity(self):
        from dual_view.mersenne import verify_core_identity
    ...
    def test_mersenne_cliff_table(self):
        from dual_view.mersenne import mersenne_cliff_table
    ...
    def test_bootstrap_cost(self):
        from dual_view.mersenne import bootstrap_cost
        cost = bootstrap_cost(6, 16)
        self.assertGreater(cost, 0)

    def test_optimal_bootstrap(self):
        from dual_view.mersenne import optimal_bootstrap
    ...
    def test_compare_bootstrap_strategies(self):
        from dual_view.mersenne import compare_bootstrap_strategies
    ...
    def test_dlog_with_lut(self):
        from dual_view.mersenne import dlog_with_lut
        k = 16
...
class TestIsometry(unittest.TestCase):
    ...
    def test_isometry_pair_test(self):
        from dual_view.isometry import isometry_pair_test
        result = isometry_pair_test(8, n_trials=20)
        self.assertGreaterEqual(result["pass_rate"], 0.9)

    def test_isometry_summary(self):
        from dual_view.isometry import isometry_summary
        summary = isometry_summary(8)
        self.assertIn("Isometry", summary)

    def test_verify_operator_algebra(self):
        from dual_view.isometry import verify_operator_algebra
        results = verify_operator_algebra([5, 6])
        self.assertIsInstance(results, dict)

    def test_trace_alpha_independence(self):
        from dual_view.isometry import trace_alpha_independence
    ...
    def test_exponent_valuation_profile(self):
        from dual_view.isometry import exponent_valuation_profile
