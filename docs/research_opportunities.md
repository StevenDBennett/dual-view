...
|--------|--------|----------|
| Exponential map isometry T6a | Proved, zero variance | `isometry.py` |
| Operator algebra identities T6b | Proved | `isometry.py` |
| Trajectory separation T2 | Proved, zero variance | `separation.py` |
| Global convergence for α=0 | Proved | `basin.py` |
| Ghost fixed point formula T4 | Proved | `basin.py` |
| Mersenne Ghost Theorem T5 | Verified n=3..11 | `mersenne.py` |
| Bootstrap k/2 optimality | Verified exhaustive | `mersenne.py` |
| Ergodic Newton corrections | Empirical (chi-square) | `padic_roots.py` |
| Trace-mod-p independence T6c | Empirical (chi-square) | `isometry.py` |
| Phase alignment in GL(2) | Empirical (68%, n=30) | `nonabelian.py` |
| Commutator depth theorem | Verified | `iwasawa.py` |
| p-adic convergence law | Proved, zero variance | `padic_roots.py` |
| Popcount compression | Unverified correlation | `padic_roots.py` |
| CRT stability correlation | Empirical, sign unexplained | `crt.py` |
| Secondary correction ε(n) | Observed, not proved | `mersenne.py` |
...
7. **Generalize to degree d maps**: beyond the cubic case
