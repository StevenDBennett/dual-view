...
```python
from dual_view.newton_dynamics import compute_iterates, dynatomic_polynomial
...
```python
from dual_view.newton_dynamics import is_cube, tonelli_shanks
...
*Research completed 2026-05-11. Ported to dual-view 2026-05-16.*
